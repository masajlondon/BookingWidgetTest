...
var clickTimeslot = function(eventData) {
  ...
  if (!config.disableConfirmPage) {
	  ...
	  var showBookingPage = function(eventData, stripePrice) {
...
/***/ (function(module, exports) {
	...
	var bookingInstant = {
	  ...
	  localization: {
	    strings: {
	      successMessageBody: 'An invitation has been sent to: <br /> %s <br />'
	    }
	  }
